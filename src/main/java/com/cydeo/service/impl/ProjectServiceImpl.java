...
public class ProjectServiceImpl implements ProjectService {
    ...
    public ProjectServiceImpl(ProjectRepository projectRepository, ProjectMapper projectMapper, UserRepository userRepository, UserService userService, UserMapper userMapper, TaskService taskService) {
    ...
    public List<ProjectDTO> listAllProjectsDetails() {
        ...
        return list.stream().map(project-> {
            ...
            dto.setUnfinishedTaskCounts(taskService.nonCompletedTask(project.getProjectCode()));
            dto.setCompleteTaskCounts(taskService.completedTask(project.getProjectCode()));
            return dto;
